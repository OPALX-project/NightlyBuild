      ...
      <body onLoad="setup()">
        ...
        <table border="0">
          ...
          <tr>
            ...
            <td style="padding: 0px 10px 0px 10px">
              <a href="https://github.com/OPALX-project/OPAL/commit/{$code_hash}" target="_blank">
                <xsl:value-of select="Tests/Revisions/code"/>
              </a>
            </td>
            <td style="padding: 0px 10px 0px 10px">
              <a href="https://github.com/OPALX-project/regression-tests/commit/{$tests_hash}" target="_blank">
